package com.ensi.country_service.demo.controllers;
...
import com.ensi.country_service.demo.services.CountryService;
...
public class CountryController {
	...
	public ResponseEntity<Country> updateCountry(@PathVariable("id") int id, @RequestBody Country country) {
	    try {
	        ...
	        existCountry.setCapital(country.getCapital()); // make sure field is 'capital'
